...
from cse import main as run_price_miner             # 🚀 NEW: Added the core price fetcher!
...
def trigger_full_pipeline():
    ...
    try:
        print("\n[API] 1/9: Fetching Daily Stock Prices (CSE)...")
        run_price_miner()
        
        print("\n[API] 2/9: Running Technical Indicators...")
        run_indicators()
        
        print("\n[API] 3/9: Running Micro-Econ Miner (CSE Corporate News)...")
        run_micro_miner()
        
        print("\n[API] 4/9: Scoring CSE Disclosures (Gemini)...")
        run_llm_scorer()
        
        print("\n[API] 5/9: Mining Alternative Web News...")
        run_alt_miner()
        
        print("\n[API] 6/9: Scoring Alternative News (Gemini)...")
        run_alt_scorer()
        
        print("\n[API] 7/9: Pulling Global Macro-Econ Data...")
        run_macro_miner()
        
        print("\n[API] 8/9: Fusing Data Streams...")
        run_merge()
        
        print("\n[API] 9/9: Awakening the XGBoost AI...")
